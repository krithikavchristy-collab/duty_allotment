...
public enum GetAllBookingsKeysPBInder implements KJUSYSPropertyBinder {
    ...
    ARENA_REPORT_FROM_DATE("arenaReportFromDate_Report_Date", "Arena Report From Date", Long.class),
    ARENA_REPORT_TO_DATE("arenaReportToDate_Report_Date", "Arena Report To Date", Long.class),

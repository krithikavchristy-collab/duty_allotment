...
public enum FetchVenueKeysPBInder implements KJUSYSPropertyBinder {
    ARENA_FETCH_VENUE_TYPE("arenaFetchVenueType_FetchVenue_Text", "Arena Fetch Venue Type", String.class),
    ARENA_FETCH_DATE("arenaFetchDate_FetchVenue_Date", "Arena Fetch Date", Long.class);
